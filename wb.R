...
windBarbs <- function(longitude, latitude, u, v,
    ...
    C <- cospi(theta / 180)
    lat1 <- lat0 + C * scale
    lon1 <- lon0 + S * scale / cospi(lat0 / 180)
...
# sibling functions, etc. Possibly 'scale' should be
# called 'length', now that I look at the parameters
# with oce in mind.
